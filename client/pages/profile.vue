          ...
          <div class="card mt-3 shadow border-0">
            <ul class="list-group list-group-flush">
              ...
              >
                ...
                <span class="text-secondary">https://coldtrash.my.id</span>
              </li>
              <li
                class="list-group-item d-flex justify-content-between align-items-center flex-wrap"
              >
                ...
                <span class="text-secondary">WardJune</span>
              </li>
              <li
                class="list-group-item d-flex justify-content-between align-items-center flex-wrap"
              >
                ...
                <span class="text-secondary">marcohiss</span>
              </li>
              <li
                class="list-group-item d-flex justify-content-between align-items-center flex-wrap"
              >
                <h6 class="mb-0">
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="feather feather-facebook mr-2 icon-inline text-info"
                  >
                    <path
          ...
          <div class="card mb-3 border-0 shadow">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-9 text-secondary">081237526491</div>
              </div>
              <hr />
              <div class="row">
                <div class="col-sm-3">
